...
const Modal = () => {
  return (
    <div className='w-screen h-screen bg-navy-blue-60 fixed top-0 left-0 justify-center items-center text-center cursor-pointer flex z-20'>
      <div className='w-4/12 bg-blue rounded-lg p-10 flex flex-col gap-3 md:w-11/12 lg:w-9/12 lg:rounded-3xl'>
        <img src={Close} alt="" className='bg-orange rounded-full p-1 w-7 ml-auto flex justify-end' />
