  ...
  return (
    <div className="p-10 py-5 w-4/5 m-auto my-5 flex justify-between items-center lg:flex-col-reverse lg:w-full lg:p-5 lg:gap-1 lg:my-3">
      <div className="w-[65%] flex flex-col gap-1.5 px-12 py-5 lg:w-full lg:px-0 lg:gap-1.5">
        <h1 className="text-blue w-10/12 lg:w-full text-2xl lg:text-3xl md:text-xl font-semibold lg:text-center">
        ...
        <form className="flex flex-col gap-2 lg:gap-1.5 mb-2">
          <div className="relative">
            <img
              src={Envelope}
              alt=""
              className="absolute top-3 left-2.5 w-3.5 lg:top-4 md:top-3.5"
            />
            <input
              className="w-[75%] rounded-full py-1.5 lg:py-3 md:py-2 px-7 placeholder:text-dark-grey placeholder:text-xs border text-dark-grey outline-none border-dark-grey text-sm lg:w-full"
              type="text"
              placeholder="Enter Email Address"
            />
          </div>
          <input
            className="bg-orange w-fit text-xs rounded-full px-5 py-2 lg:py-3 cursor-pointer md:py-2.5 hover:bg-orange-80 lg:m-auto"
            type="submit"
            value="Subscribe"
          />
        </form>
        ...
        <h1 className="text-blue font-semibold text-sm">
